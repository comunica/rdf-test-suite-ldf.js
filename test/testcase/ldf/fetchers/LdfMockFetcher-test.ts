...
describe('LdfMockFetcher', () => {
  ...
  const object = new LdfTestCaseEvaluation(testCaseData, props, new LdfResponseMockerFactory(<any> { startPort: 5000 }));
...
@prefix void: <http://rdfs.org/ns/void#>.`);
    ...
    const object2 = new LdfTestCaseEvaluation(testCaseData, props2, new LdfResponseMockerFactory(<any> { startPort: 5000 }));
